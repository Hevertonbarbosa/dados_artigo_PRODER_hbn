...
## MEDIDAS PARA AVALIAÇÃO DO MODELO (< melhor). ####
...
## PREVISÃO FINAL. ####
# Unificar os dados e gerar uma previsão 12 passos à frente.
...
#View(previsao_final)
write.csv(previsao_final,file = "Results/32.previsao_final.csv",row.names = F)
